...
class ScenarioForm(Form):
    ...
    transfer_buyer_share = DecimalField('transfer_buyer_share',
                                        [validators.NumberRange(min=0, max=100)])
    recordation_cost = DecimalField('recordation_cost',
                                    [validators.NumberRange(min=0, max=100)])
    recordation_buyer_share = DecimalField('recordation_buyer_share',
                                           [validators.NumberRange(min=0, max=100)])
